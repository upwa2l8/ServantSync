...
| `wwwroot/img/servantsync-marketing.svg`    | README, splash, email signature  | The **marketing** wordmark. Visible at 180–400 px. NOT used as the navbar / favicon.       |
...
| Token              | Hex        | Used for                                                                  |
|--------------------|------------|---------------------------------------------------------------------------|
| `coolSide / 0%`    | `#3730a3`  | Indigo base of the product-mark gradient, navbar wordmark, marketing lockup |
...
| `Components/Account/Pages/Login.razor`            | Splash hero using `wwwroot/img/servantsync-marketing.svg` (width 180, centered)       |
| `Components/Account/Pages/Register.razor`         | Smaller splash using the same asset (width 140, centered)                            |
