...
namespace ServantSync.Data.Migrations
{
    ...
    [Migration("20260916155442_AddSlotTradeRequests")]
    partial class AddSlotTradeRequests
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ServantSync.Models.SlotTradeRequest", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
                    ...
                    b.HasIndex("TargetAssignmentId", "Status");

                    b.ToTable("SlotTradeRequests");
                });
            ...
            modelBuilder.Entity("ServantSync.Models.SlotTradeRequest", b =>
                {
                    b.HasOne("ServantSync.Models.Person", "Requester")
                        .WithMany()
                        .HasForeignKey("RequesterUserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("ServantSync.Models.Assignment", "TargetAssignment")
                        .WithMany()
